...
#define FIREBASE_HOST "servomasterdev-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "hHwEzwtyERO7m1ULQpmiqYrmIHWjZJbCIYrtBP1M"
...
int inp3 = 15;
int inp4 = 2;
// This variable will store the database string for this device
String data_from_db = "";
